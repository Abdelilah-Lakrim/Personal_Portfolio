          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-lg text-dark-700 mb-6">
                Hi there! I'm <span className="font-semibold text-primary-600">Abdelilah Lakrim</span>, a passionate Full Stack Developer based in Morocco with over 5 years of experience in creating beautiful, functional, and user-centered digital experiences.
              </p>
              <p className="text-lg text-dark-700 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 mb-8">
                <div>
                  <h3 className="text-dark-800 font-semibold">Name:</h3>
