        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-primary-900 to-secondary-500 rounded-full blur-3xl opacity-20"></div>
              <img src="public/image/Portrait.jpg" className="relative z-10 w-64 h-64 sm:w-80 sm:h-80 rounded-full border-4 border-white shadow-xl"/>
