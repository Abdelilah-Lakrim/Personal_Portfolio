        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-dark-600">Casablanca, Morocco</p>
                </div>
              </div>
            ...
            <div className="mt-8 rounded-xl overflow-hidden shadow-sm h-48 bg-gray-200">
              <img
                src="https://www.visitmorocco.com/sites/default/files/styles/thumbnail_events_slider/public/thumbnails/image/city-panorama.-casablanca-morocco.-africa-marianna-ianovska.jpg?itok=h4FjZSIp"
                alt="Morocco Map"
