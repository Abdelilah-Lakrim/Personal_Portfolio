        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              ...
              <img 
              src="https://scontent.fcmn3-1.fna.fbcdn.net/v/t39.30808-6/487111031_3953698674903601_4148537156289186369_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=6ee11a&_nc_eui2=AeEU6oULbOpcrYs-ql4JzUfGxUYZrzQHGZ_FRhmvNAcZn1OU7_CRHlZ_ASZL3VgJJqPd_ONQPEb1Cc2Ykt84aALa&_nc_ohc=1SY_87L6_7sQ7kNvwHjoDVW&_nc_oc=AdkjaX2vC7TwOfIHAk8WJu9SeWhRmnsdxUZoRS36eWDp9ycBV3SaRb51yc7siyAiw_c&_nc_zt=23&_nc_ht=scontent.fcmn3-1.fna&_nc_gid=F0LuGPtQ8xIBmds83f01mA&oh=00_AfKLL0SummCROns5UTEYWbJNm20oVzxlzVuzkyLtXrfcaQ&oe=6833ADED" 
              className="relative z-60 w-64 h-64 sm:w-80 sm:h-80 rounded-full border-4 border-white shadow-xl"/>
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-lg z-20">
                <div className="text-xs font-medium text-center">
                  ...
                  <span className="block text-primary-800 font-bold text-2xl">3+</span>
