        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              ...
              <img  className="relative z-10 w-64 h-64 sm:w-80 sm:h-80 rounded-full object-cover border-4 border-white shadow-xl"
                src="https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpegauto=compress&cs=tinysrgb&w=800"
