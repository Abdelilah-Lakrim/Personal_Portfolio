        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              ...
              <img src="https://drive.google.com/uc?export=view&id=1GQxNmxewdZcNG6fkoP1-A5sdQlKjKFCN" className="relative z-10 w-64 h-64 sm:w-80 sm:h-80 rounded-full border-4 border-white shadow-xl"/>
