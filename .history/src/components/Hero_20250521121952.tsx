        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              ...
              <img src="https://drive.google.com/file/d/1HKNXf952zY0Xfo3P-HrRoiYzu3AU2j0-/view?usp=sharing" className="relative z-10 w-64 h-64 sm:w-80 sm:h-80 rounded-full border-4 border-white shadow-xl"/>
