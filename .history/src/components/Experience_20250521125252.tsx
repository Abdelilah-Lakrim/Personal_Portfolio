...
const Experience: React.FC = () => {
  ...
  const education = [
    ...
    {
      id: 2,
      degree: 'Computer Networks and Systems',
      institution: 'Specialized Institute of Applied Technology',
      location: 'Casablanca, Morocco',
      duration: '2018 - 2020',
      description: [
        'Completed a two-year technical diploma in Computer Networks and Systems',
        'Gained hands-on experience in network configuration and troubleshooting',
      ],
    },
  ];
