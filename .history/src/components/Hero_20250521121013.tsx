        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              ...
              <img 
                src="https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpegauto=compresshttps://drive.google.com/file/d/1GQxNmxewdZcNG6fkoP1-A5sdQlKjKFCN/view?usp=sharing&cs=tinysrgb&w=800"
